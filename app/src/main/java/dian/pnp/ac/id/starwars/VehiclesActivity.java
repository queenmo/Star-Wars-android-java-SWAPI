...
public class VehiclesActivity extends AppCompatActivity {
    ...
    private static final String STATS_URL = "https://swapi.dev/api/vehicles/";
    RecyclerView rcdata;
    ArrayList<VehicleModel> dataArrayList;
    ...
    private void prosesdata(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, STATS_URL, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(VehiclesActivity.this, ""+error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void handlerespon(String response) {
        ...
        try{
            ...
            for (int i=0; i<jsonArray.length(); i++){
                ...
                dataArrayList.add(VehicleModel);
            }

            VehicleAdapter = new VehicleAdapter(VehiclesActivity.this, dataArrayList);
            rcdata.setAdapter(VehicleAdapter);
            VehicleAdapter.notifyDataSetChanged();

        }
        catch (Exception e){
            Toast.makeText(VehiclesActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
        }
    }
}