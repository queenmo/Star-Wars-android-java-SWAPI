...
public class SpeciesActivity extends AppCompatActivity {
    ...
    private static final String STATS_URL = "https://swapi.dev/api/species/";
    RecyclerView rcdata;
    ArrayList<SpeciesModel> dataArrayList;
    ...
    private void prosesdata(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, STATS_URL, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(SpeciesActivity.this, ""+error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        try{
            ...
            for (int i=0; i<jsonArray.length(); i++){
                ...
                SpeciesModel SpeciesModel = new SpeciesModel(
                        ...
                        obj.getString("average_height"),
                        obj.getString("skin_colors"),
                        obj.getString("average_lifespan"));

                dataArrayList.add(SpeciesModel);
            }

            speciesAdapter = new SpeciesAdapter(SpeciesActivity.this, dataArrayList);
            rcdata.setAdapter(speciesAdapter);
